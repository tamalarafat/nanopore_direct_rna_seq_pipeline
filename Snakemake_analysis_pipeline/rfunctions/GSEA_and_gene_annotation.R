...
output_deg_table <- args[4]
temp_dir <- paste0(dirname(output_deg_table), "/")

# Annotate the genes table
gene_set_annotation <- annotate_genes(file_paths, config_file_path, gene_transcript_table)
...
perform_GSEA_DEG(gene_set, hg_entrez_universe, deg_table, temp_dir)
